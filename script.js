...
function driversL5(passedTest) {
  if(passedTest) {
    console.log(firstName); // will show undefined
    var firstName = 'John';
...
function driversL6(passedTest) {
  // console.log(firstName); // can not run code before it is declared
  let firstName;
...
console.log(a + b); // Not inside the block, so it will show not defined.
...
isFullAge6(1990, 1999, 1965, 2016, 2018, 2010);
...
isFullAge6(21, 1990, 1999, 1965, 2016, 2018, 2010);
*/
...
if(question.has(4)) {
  // question.delete(4); // delete specific question
  // console.log('Answer 4 is here')  
}

// question.clear(); // clear entire map
...
const john6 = new Person6('John', 1989, 'teacher');
...
var johnAthlete5 = new Athlete5('John', 1990, 'swimmer', 3, 6);
...
/*
Suppose that you are working in a small town administration, and you are in charge of two
town elements:
1. Parks
2. Streets

It is a very small town, so right now there are only 3 parks and 4 streets. All parks and
streetsnhave a name and a build year.

At an end-pf-year meeting, your boss wants a final report with the following:
...
const allStreets = [new Street('Ocean Avenue', 1999, 1.1, 4),
                    ...
                    new Street('4th Street', 1989, 0.8),
                    new Street('Sunset Boulevard', 1978, 2.5, 5)];
